                ...
                <tr>
                    ...
                    <td>
                        <div class="table-actions">
                            <form method="POST" action="{{ route('admin.applications.restore', $application->id) }}" onsubmit="return confirm('Pulihkan pengajuan ini ke daftar utama?')">
                                @csrf
                                @method('PATCH')
                            ...
                            <form method="POST" action="{{ route('admin.applications.force-delete', $application->id) }}" onsubmit="return confirm('Hapus pengajuan ini secara permanen? Tindakan ini tidak dapat dibatalkan.')">
                                @csrf
                                @method('DELETE')
