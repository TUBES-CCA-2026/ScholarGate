    ...
    <aside class="sidebar" id="mainSidebar" aria-label="Navigasi utama">
        ...
        <nav class="nav-menu">
            @if($isAdmin)
                ...
                <a href="{{ route('admin.applications.index') }}" class="nav-link {{ request()->routeIs('admin.applications.index') || request()->routeIs('admin.applications.show') ? 'active' : '' }}"><span>▣</span> Pengajuan</a>
                ...
                <a href="{{ route('admin.applications.recycle-bin') }}" class="nav-link {{ request()->routeIs('admin.applications.recycle-bin') ? 'active' : '' }}"><span>♻</span> Recycle Bin</a>
            @else
